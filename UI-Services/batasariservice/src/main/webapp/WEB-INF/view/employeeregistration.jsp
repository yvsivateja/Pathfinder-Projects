			...
			<form:form method="POST" commandName="employeeRegistrationDTO"
				...
				<div class="col-xs-20 col-sm-9">
					...
					<div class="col-sm-13 main">
						...
						<div class="form-group form-group-sm">
							<label class="col-sm-2 control-label">Email Id :<span
								class="mandatory"> *</span></label>
							<div class="col-sm-9">
						...
						<div class="form-group form-group-sm">
							<label class="col-sm-2 control-label">Contact No :<span
								class="mandatory"> *</span></label>
							<div class="col-sm-9">
						...
						<div class="form-group form-group-sm">
							<label class="col-sm-2 control-label">Age :<span
								class="mandatory"> *</span></label>
							<div class="col-sm-9">
								<form:input path="age" cssClass="form-control" maxlength="40" />
								<c:set var="ageError">
